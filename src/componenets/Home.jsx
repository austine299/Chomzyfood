    ...
    <div className="bg-slate-50 md:pl-10 md:pr-10 pt-20">
      <section id="hero" className="section-p1">
        <div className="banner">
          ...
          <img src={`${process.env.PUBLIC_URL}/videoimg/vd2.jpg`} alt="" className="w-full" />
        </div>
      </section>
      <section
        id="collection"
      ...
      <section id="banner" className="mt-10">
        <div className="flex">
          <img src={`${process.env.PUBLIC_URL}/videoimg/wh2.jpg `}alt="" className="w-[50%] h-[500px]" />
          <img src={`${process.env.PUBLIC_URL}/videoimg/wh16.jpg`} alt="" className="w-[50%] h-[500px]" />
        </div>
      </section>
    </div>
  );
